...
CAIXA_AUTHENTICATION_FORBIDDEN = "Login CAIXA retornou Forbidden ao continuar a autenticação. A sessão atual foi bloqueada pelo serviço; reinicie o navegador/perfil e tente novamente"
